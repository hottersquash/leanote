...
function scrollToHeading(self, tagName, text) {
	var iframe = $("#content");
...
function genNav() {
	...
	for(var i = 0; i < hs.length; ++i) {
		...
		// scrollTo在page.js中定义
		titles += '<li class="nav-' + tagName + '"><a data-a="' + tagName + '-' + encodeURI(text)+'" onclick="scrollToHeading(this, \'' + tagName + '\', \'' + text + '\')">' + text + '</a></li>';
	}
	titles += "</ul>";
